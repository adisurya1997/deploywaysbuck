...
func (h *handlerTransaction) CreateTransaction(w http.ResponseWriter, r *http.Request) {
	...
	transaction, _ := h.TransactionRepository.GetTransactionStatus()
...
func (h *handlerTransaction) UpdateTransaction(w http.ResponseWriter, r *http.Request) {
	...
	transaction, err := h.TransactionRepository.GetTransactionStatus()
	if err != nil {
		w.WriteHeader(http.StatusInternalServerError)
...
func (h *handlerTransaction) Notification(w http.ResponseWriter, r *http.Request) {
	...
	if transactionStatus == "capture" {
	  if fraudStatus == "challenge" {
		...
		h.TransactionRepository.UpdateNewTransaction("pending",  orderId)
	  } else if fraudStatus == "accept" {
		// TODO set transaction status on your database to 'success'
		SendMail("success", transaction)
		h.TransactionRepository.UpdateNewTransaction("success",  orderId)
	  }
	  ...
	  h.TransactionRepository.UpdateNewTransaction("failed",  orderId)
